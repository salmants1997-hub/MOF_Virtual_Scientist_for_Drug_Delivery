...
Agent 3: Recipe Creator — Recommends synthesis procedures and evaluates each MOF's potential for targeted drug delivery.
The system is powered by Groq’s LLM API and provides structured output, including biocompatible MOF tables and synthesis steps, helping biochemists shortlist candidates for experimental validation.
